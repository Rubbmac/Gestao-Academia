...
{
    public partial class AddSecretaria : Form
    {
        string nome;
        string morada;
        int contacto;
        ...
        public AddSecretaria(Empresa emp)
        {
            InitializeComponent();
            this.emp = emp;
        }
        ...
        private void btn_valid_Click(object sender, EventArgs e)
        {
            ...
            //Inserção id de diretor
            try
            {

                idDir = int.Parse(txt_dir.Text);
                if (emp.ListDiretores.Find(d => d.ID == int.Parse(txt_dir.Text)) != null) { 
                idDir = int.Parse(txt_dir.Text);
                lbl_dir.Text = "Validado";
                lbl_dir.ForeColor = Color.Green;
            ...
            {
                lbl_dir.Text = "ID Inválido";
                lbl_dir.ForeColor = Color.Red;
                lbl_dir.Visible = true;
            }
            catch (Exception)
            {
                lbl_dir.Text = "Valor inválido";
                lbl_dir.ForeColor = Color.Red;
                lbl_dir.Visible = true;
            }
            ...
            try
            {
                if (txt_area.Text == "") { throw new Exception(); }
                area = txt_area.Text;
        ...
        private void btn_inserir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                emp.AddSecretaria(nome, morada, contacto, salario, iniContrato, fimContrato, regCriminal, idDir, area);
